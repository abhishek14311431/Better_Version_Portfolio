...
const DoorSection = ({
    ...
    const openDoor = useCallback((fastMode = false) => {
        ...
        const handleDuration = fastMode ? 0.01 : 0.08;
        const doorDuration = fastMode ? 0.01 : 0.35;
        const flyDuration = fastMode ? 0.01 : 0.75;
        ...
        <group position={[pivotX, position[1], position[2]]}>
            ...
            <group ref={groupRef}>
                ...
                <mesh position={[wallOffsetX, 0, 0]} geometry={wallWithHoleGeometry}>
                    <meshBasicMaterial color="#fcf3c6" map={wallTexture} roughness={1} metalness={0} side={THREE.DoubleSide} />
                </mesh>
